...
numeros = list() #LISTA ([0], [1], [2]...[n])
for quantidade in range(0,5):
    numeros[quantidade] = input('Digite um numero: ')

print('O maior número que eu achei foi ',max(numeros))
...
nome_completo('Raoni', 'Silva')

def nome_completo2(nome, sobrenome):
    return nome, sobrenome
dado1 = input('Digite o nome: ')
dado2 = input('Digite o sobrenome: ')
print(nome_completo2(dado1, dado2))
    #nome = dado1
    #sobrenome = dado2